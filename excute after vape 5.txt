...
local EmeraldArmour = COB("Blatant", {
...
game.ReplicatedStorage.Items.Iron:Clone().Parent = game.ReplicatedStorage.Inventories[lplr.Name]
        end
    end,
    Default = false,
    HoverText = "Gives you emerald tools and emerald armour."
})
local BigHead = COB("Blatant", {
    Name = "BigHead",
    Function = function(callback) 
        if callback then
